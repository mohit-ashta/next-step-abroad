      ...
      <div className="container px-4 mx-auto">
        <div className="pb-10 mb-10 border-b border-gray-700 items-center text-black">
          <div className="grid lg:grid-cols-2 items-center">
            ...
            <div className="flex lg:justify-end justify-between items-center gap-3">
        ...
        <div className="flex flex-wrap -mx-4 mb-18">
          <div className="w-full lg:w-2/5 px-4 mb-5 lg:mb-0">
            <div className="xs:max-w-xs">
              ...
              <form action="">
                ...
                <div className="flex border bg-white rounded-[31px] items-center">
                  <input
                    className="w-full p-12 pr-4 py-4 text-sm text-black placeholder-gray-400 rounded-l-[31px] outline-none"
                    type="email"
                    placeholder="mohit.ashta@icloud.com"
                  />
                  <button
